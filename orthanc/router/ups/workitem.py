...
class UPSWorkitem:
    ...
    def __init__(
        ...
        input_configuration_id: str | None = None,
    ) -> None:
        """
    ...
    def _create_dicom_json(
        ...
        if input_mapping:
            processing_params = self._build_processing_parameters(
                        ...
                        "Value": [
                            {
                                ...
                                "00080104": {
                                    "vr": "LO",
                                    "Value": ["Input Configuration Identifier"],
                                },
                            }
                        ],
                    },
        ...
        if current_state == "IN_PROGRESS" and (
            ...
            if progress_percent is not None:
                progress_item["00741004"] = {
                    "vr": "DS",
                    "Value": [str(progress_percent)],
                }  # Procedure Step Progress
            if progress_description:
                progress_item["00741006"] = {
                    "vr": "ST",
